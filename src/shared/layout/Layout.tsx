  ...
  return (
    <div className="flex flex-col min-h-screen bg-neutral-50 text-neutral-900">
      ...
      <main className="flex-1 w-full pt-16 flex flex-col">
        ...
        {!isHomePage && (
          <footer className="bg-neutral-900 text-white py-12 px-6 flex flex-col items-center justify-center mt-auto border-t border-neutral-800">
            <div className="flex flex-col items-center gap-6 max-w-4xl mx-auto text-center">
              <img src="/logo.png" alt="Turismo Patagones" className="h-16 opacity-90 rounded-md" />
              
              <div className="flex gap-4">
                <a href="https://www.facebook.com/TurismoPartidodePatagones/" target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-white/30 p-3 rounded-full backdrop-blur-sm transition-colors">
                ...
                <a href="https://www.instagram.com/turismopatagones/#" target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-white/30 p-3 rounded-full backdrop-blur-sm transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
                </a>
                <a href="https://api.whatsapp.com/send/?phone=5492920366892&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-white/30 p-3 rounded-full backdrop-blur-sm transition-colors">
              ...
              <div className="flex flex-col items-center gap-2 mt-4">
                <p className="text-white/70 font-semibold text-sm bg-white/10 px-4 py-2 rounded-lg border border-white/20">Prototipo no oficial de modernización turística</p>
                <p className="text-white/50 text-xs">© 2026 Turismo Partido de Patagones.</p>
              </div>
            </div>
          </footer>
        )}
